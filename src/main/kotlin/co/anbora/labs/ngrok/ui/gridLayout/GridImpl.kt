...
import co.anbora.labs.ngrok.ui.checkTrue
import co.anbora.labs.ngrok.ui.gridLayout.impl.ColumnsSizeCalculator
...
class PreCalculationData(val minimumSize: Dimension, val preferredSize: Dimension, val constraints: Constraints) {
...
data class PreferredSizeData(val preferredSize: Dimension, val outsideGaps: Gaps)
